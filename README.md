In this project, the data is transferred from the generator to the AD9226 ADC, digitized, accepted by the FPGA Cyclone 5 (5CEFA2F23I7) and adjusted using the w5500 chip.
